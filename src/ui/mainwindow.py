...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.comboBox_log_level, 2, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_save_format, 2, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_auto_manage_config, 1, 6, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButton_select_folder, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_select_path, 1, 5, 1, 1)

        self.lineEdit_save_path = QLineEdit(self.layoutWidget)
        self.lineEdit_save_path.setObjectName(u"lineEdit_save_path")

        self.gridLayout.addWidget(self.lineEdit_save_path, 1, 1, 1, 4)
        ...
        self.gridLayout.addWidget(self.pushButton_open_folder, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_always_on_top, 0, 6, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.comboBox_reclip_method, 1, 3, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.comboBox_clip_align, 1, 5, 1, 1)

        self.label_25 = QLabel(self.layoutWidget)
        self.label_25.setObjectName(u"label_25")
        self.label_25.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.gridLayout_6.addWidget(self.label_25, 0, 2, 1, 4)
...
"Capture", None))
        ...
        self.comboBox_stitch_method.setCurrentText(QCoreApplication.translate("MainWindow", u"SSIM", None))
        ...
        self.comboBox_clip_align.setCurrentText(QCoreApplication.translate("MainWindow", u"\u5c45\u4e2d", None))
