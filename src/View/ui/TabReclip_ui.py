...
class Ui_TabReclip(object):
    def setupUi(self, TabReclip):
        ...
        self.gridLayout.addWidget(self.comboBox_font_name, 17, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_live_preview, 10, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_margin_title, 14, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_margin_width, 15, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_each_line_bar_num, 5, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_reclip_method, 2, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_27, 16, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_title, 13, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.line, 12, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_add_page_num, 19, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_open_style, 21, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_clip_resize, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_save_style, 21, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_clip_align, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_each_line_ength, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_save_pdf, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_add_title, 19, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_clip_margin, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_margin_height, 16, 3, 1, 1)
        ...
        self.gridLayout.addItem(self.verticalSpacer_2, 22, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_resize_threshold, 9, 3, 1, 1)
    ...
    def retranslateUi(self, TabReclip):
        ...
        self.checkBox_add_page_num.setText(QCoreApplication.translate("TabReclip", u"\u6dfb\u52a0\u9875\u7801", None))
        self.label_23.setText(QCoreApplication.translate("TabReclip", u"\u7f29\u653e\u9608\u503c\uff1a", None))
        self.pushButton_print_score.setText(QCoreApplication.translate("TabReclip", u"\u6253\u5370", None))
...
#if QT_CONFIG(tooltip)
        self.spinBox_each_line_ength.setToolTip(QCoreApplication.translate("TabReclip", u"<html><head/><body><p>Fixed lenght each row. Use the length of <span style=\" font-weight:700;\">first n</span> sections.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_save_pdf.setText(QCoreApplication.translate("TabReclip", u"\u4fdd\u5b58pdf", None))
        self.checkBox_add_title.setText(QCoreApplication.translate("TabReclip", u"\u6dfb\u52a0\u6807\u9898", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.pushButton_show_style.setText(QCoreApplication.translate("TabReclip", u"\u5237\u65b0\u6837\u5f0f", None))
