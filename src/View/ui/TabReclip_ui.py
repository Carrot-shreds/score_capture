...
class Ui_TabReclip(object):
    def setupUi(self, TabReclip):
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_resize_threshold, 10, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_each_line_bar_num, 6, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_live_preview, 11, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_clip_align, 8, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_clip_resize, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_margin_height, 17, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_margin_width, 16, 3, 1, 1)

        self.checkBox_add_page_num = QCheckBox(self.scrollAreaWidgetContents)
        self.checkBox_add_page_num.setObjectName(u"checkBox_add_page_num")

        self.gridLayout.addWidget(self.checkBox_add_page_num, 20, 3, 1, 1)

        self.pushButton_reclip = QPushButton(self.scrollAreaWidgetContents)
        self.pushButton_reclip.setObjectName(u"pushButton_reclip")

        self.gridLayout.addWidget(self.pushButton_reclip, 1, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_28, 15, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_save_style, 22, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_margin_title, 15, 3, 1, 1)
        ...
        self.gridLayout.addItem(self.verticalSpacer_2, 23, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_clip_margin, 4, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_each_line_ength, 7, 3, 1, 1)
        ...
        sizePolicy1.setHeightForWidth(self.comboBox_font_name.sizePolicy().hasHeightForWidth())
        self.comboBox_font_name.setSizePolicy(sizePolicy1)
        self.comboBox_font_name.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToMinimumContentsLengthWithIcon)

        self.gridLayout.addWidget(self.comboBox_font_name, 18, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_open_style, 22, 0, 1, 1)

        self.checkBox_add_title = QCheckBox(self.scrollAreaWidgetContents)
        self.checkBox_add_title.setObjectName(u"checkBox_add_title")

        self.gridLayout.addWidget(self.checkBox_add_title, 20, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_reclip_method, 3, 3, 1, 1)
        ...
        sizePolicy2.setHeightForWidth(self.lineEdit_title.sizePolicy().hasHeightForWidth())
        self.lineEdit_title.setSizePolicy(sizePolicy2)

        self.gridLayout.addWidget(self.lineEdit_title, 14, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_show_style, 2, 0, 1, 1)

        self.pushButton_print_score = QPushButton(self.scrollAreaWidgetContents)
        self.pushButton_print_score.setObjectName(u"pushButton_print_score")

        self.gridLayout.addWidget(self.pushButton_print_score, 1, 3, 1, 1)

        self.pushButton_save_pdf = QPushButton(self.scrollAreaWidgetContents)
        self.pushButton_save_pdf.setObjectName(u"pushButton_save_pdf")

        self.gridLayout.addWidget(self.pushButton_save_pdf, 2, 3, 1, 1)
    ...
    def retranslateUi(self, TabReclip):
        ...
        self.doubleSpinBox_resize_threshold.setToolTip(QCoreApplication.translate("TabReclip", u"<html><head/><body><p>Resize clip when clip_width&gt;(page_width*threshold).</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.spinBox_each_line_bar_num.setToolTip(QCoreApplication.translate("TabReclip", u"<html><head/><body><p>Fixed bar nums each row.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.checkBox_live_preview.setText(QCoreApplication.translate("TabReclip", u"Live Preview", None))
        self.comboBox_clip_align.setItemText(0, QCoreApplication.translate("TabReclip", u"Left", None))
        self.comboBox_clip_align.setItemText(1, QCoreApplication.translate("TabReclip", u"Center", None))
        self.comboBox_clip_align.setItemText(2, QCoreApplication.translate("TabReclip", u"Right", None))

        self.comboBox_clip_align.setCurrentText(QCoreApplication.translate("TabReclip", u"Left", None))
        self.label_18.setText(QCoreApplication.translate("TabReclip", u"Reclip mode:", None))
        self.checkBox_clip_resize.setText(QCoreApplication.translate("TabReclip", u"Resize Clips", None))
        self.label_26.setText(QCoreApplication.translate("TabReclip", u"Vertical Margin:", None))
        self.label_19.setText(QCoreApplication.translate("TabReclip", u"Clip Alignment:", None))
        self.checkBox_add_page_num.setText(QCoreApplication.translate("TabReclip", u"Add Page Number", None))
#if QT_CONFIG(tooltip)
        self.pushButton_reclip.setToolTip(QCoreApplication.translate("TabReclip", u"<html><head/><body><p>Reclip horizontal stitched image to reclip image, then generate the styled final image.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_reclip.setText(QCoreApplication.translate("TabReclip", u"Reclip", None))
        self.label_20.setText(QCoreApplication.translate("TabReclip", u"Bars per Row:", None))
        self.label_22.setText(QCoreApplication.translate("TabReclip", u"Clip Horiz. Margin:", None))
        self.label_28.setText(QCoreApplication.translate("TabReclip", u"Title Height:", None))
        self.label_23.setText(QCoreApplication.translate("TabReclip", u"Resize threshold:", None))
        self.pushButton_save_style.setText(QCoreApplication.translate("TabReclip", u"Save StyleData As", None))
        self.label_29.setText(QCoreApplication.translate("TabReclip", u"Font Family:", None))
        self.label_21.setText(QCoreApplication.translate("TabReclip", u"Max. Row Length:", None))
#if QT_CONFIG(tooltip)
        self.spinBox_clip_margin.setToolTip(QCoreApplication.translate("TabReclip", u"<html><head/><body><p>Large magin to include bar nums at both end of each row.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        self.spinBox_each_line_ength.setToolTip(QCoreApplication.translate("TabReclip", u"<html><head/><body><p>Maximum length of each row. Use the length of first<span style=\" font-weight:700;\"> n</span> bars.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.label_24.setText(QCoreApplication.translate("TabReclip", u"Score Title:", None))
        self.pushButton_open_style.setText(QCoreApplication.translate("TabReclip", u"Open StyleData", None))
        self.checkBox_add_title.setText(QCoreApplication.translate("TabReclip", u"Add Title", None))
        self.comboBox_reclip_method.setItemText(0, QCoreApplication.translate("TabReclip", u"Limit Bar Nums", None))
        self.comboBox_reclip_method.setItemText(1, QCoreApplication.translate("TabReclip", u"Fill Limit Width", None))

#if QT_CONFIG(tooltip)
        self.comboBox_reclip_method.setToolTip(QCoreApplication.translate("TabReclip", u"<html><head/><body><p>When to make a clip and switch to a new line.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.comboBox_reclip_method.setCurrentText(QCoreApplication.translate("TabReclip", u"Limit Bar Nums", None))
        self.label_27.setText(QCoreApplication.translate("TabReclip", u"Horizontal Margin:", None))
#if QT_CONFIG(tooltip)
        self.pushButton_show_style.setToolTip(QCoreApplication.translate("TabReclip", u"<html><head/><body><p>Generate final image from reclip image with current style settings.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.pushButton_show_style.setText(QCoreApplication.translate("TabReclip", u"Restyle", None))
        self.pushButton_print_score.setText(QCoreApplication.translate("TabReclip", u"Print", None))
        self.pushButton_save_pdf.setText(QCoreApplication.translate("TabReclip", u"Save PDF", None))
    # retranslateUi
