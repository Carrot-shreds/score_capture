...
class Ui_TabSettings(object):
    def setupUi(self, TabSettings):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 732, 336))
        ...
        self.gridLayout.addWidget(self.spinBox_region_y, 0, 7, 1, 1)

        self.spinBox_region_height = QSpinBox(self.groupBox)
        self.spinBox_region_height.setObjectName(u"spinBox_region_height")
        sizePolicy.setHeightForWidth(self.spinBox_region_height.sizePolicy().hasHeightForWidth())
        self.spinBox_region_height.setSizePolicy(sizePolicy)
        self.spinBox_region_height.setMinimumSize(QSize(80, 0))
        self.spinBox_region_height.setMaximum(2000)

        self.gridLayout.addWidget(self.spinBox_region_height, 1, 7, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_region_width, 1, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_opacity, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBox_region_x, 0, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_auto_close, 1, 0, 1, 1)

        self.checkBox_limit_move = QCheckBox(self.groupBox)
        self.checkBox_limit_move.setObjectName(u"checkBox_limit_move")

        self.gridLayout.addWidget(self.checkBox_limit_move, 1, 1, 1, 1)
        ...
        sizePolicy.setHeightForWidth(self.pushButton_rename_folder.sizePolicy().hasHeightForWidth())
        self.pushButton_rename_folder.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.comboBox_compare_method.sizePolicy().hasHeightForWidth())
        self.comboBox_compare_method.setSizePolicy(sizePolicy1)

        self.gridLayout_2.addWidget(self.comboBox_compare_method, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.checkBox_keep_last, 0, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBox_compare_threshold, 0, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.line_2, 0, 7, 2, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_image_rebuild, 0, 8, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.comboBox_capture_tool, 1, 1, 1, 1)

        self.checkBox_reverse_image = QCheckBox(self.groupBox_2)
        self.checkBox_reverse_image.setObjectName(u"checkBox_reverse_image")

        self.gridLayout_2.addWidget(self.checkBox_reverse_image, 1, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.doubleSpinBox_capture_delay, 1, 6, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pushButton_image_reorder, 1, 8, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.checkBox_imageViewer_show_tools, 0, 0, 1, 1)


        self.gridLayout_3.addWidget(self.groupBox_4, 2, 1, 1, 2)
